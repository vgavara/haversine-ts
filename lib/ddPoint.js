...
class DDPoint {
    ...
    constructor(latitude, longitude) {
        if (latitude < -90 || latitude > 90 || longitude < -180 || longitude > 180)
            throw new Error("Coordinate(s) out of range: they must be in the range -180 to 180");
    ...
    toDMSCoordinate(ddCoordinate) {
        ...
        return new dmsPoint_1.DMSCoordinate(ddCoordinate >= 0 ? degrees : -degrees, minutes, seconds);
    }
}
